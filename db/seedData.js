...
async function createUsersTable() {
  try {
    ...
    console.error("Error Building users tables");
    throw error;
  }
}
...
async function createActivitiesTable() {
  try {
    ...
    console.error("Error Building activities tables");
    throw error;
  }
}
...
async function createRoutinesTable() {
  try {
    ...
    console.error("Error Building routines tables");
    throw error;
  }
}
...
async function createRoutineActivitiesTable() {
  try {
    ...
    console.error("Error Building routine_activities tables");
    throw error;
  }
}
